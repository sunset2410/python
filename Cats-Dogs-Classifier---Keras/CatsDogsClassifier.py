...
#from keras.utils.vis_utils import to_graph
...
training_set = train_datagen.flow_from_directory("F:/python_project/python/Cats-Dogs-Classifier---Keras/dataset/training_set/" ,
                                                 target_size = (64, 64),
                                                 batch_size = 32,
                                                 class_mode = 'binary')

test_set = test_datagen.flow_from_directory("F:/python_project/python/Cats-Dogs-Classifier---Keras/dataset/test_set/",
                                            target_size = (64, 64),
                                            batch_size = 32,
                                            class_mode = 'binary')
#start_time = datetime.now()
classifier.fit_generator(training_set,
                         steps_per_epoch = 80, #number of images in the training set
                         epochs = 100,
...
test_image = image.load_img("F:/python_project/python/Cats-Dogs-Classifier---Keras/dataset/single_prediction/cat_or_dog_1.jpg", target_size=(64,64))
...
classifier.save('classifier_chieu.h5')
